...
export const DRINKS: Drink[] = [
  {
    ...
    keywords: ['стейк', 'говядина', 'мясо', 'рибай', 'ростбиф', 'баранина', 'жаркое', 'шашлык из говядины', 'антрекот', 'карпаччо', 'вырезка', 'филе говядины', 'томагавк', 'флэнк', 'бургер из говядины', 'говяжьи щёки', 'говяжий язык', 'оссобуко', 'брисket', 'брискет', 'мясо по-французски', 'котлета'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['лосось', 'семга', 'рыба', 'форель', 'морепродукты', 'крем-суп', 'сливочный', 'паста со сливками', 'судак', 'треска', 'щука', 'сом', 'стерлядь', 'палтус', 'тилапия', 'окунь', 'карп', 'рыбный суп', 'уха', 'рыба на гриле', 'запечённая рыба', 'рыба в сливочном соусе', 'рыбные котлеты', 'сливочная паста', 'паста с курицей в сливках', 'жульен с курицей'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['карбонара', 'паста', 'спагетти', 'яйцо', 'бекон', 'ветчина', 'яичница', 'омлет', 'равиоли', 'паста болоньезе', 'тальятелле', 'феттучини', 'пенне', 'ригатони', 'фарфале', 'паста с беконом', 'паста с ветчиной', 'паста аматричана', 'паста с яйцом', 'гратен', 'запеканка', 'крокеты', 'пицца четыре сыра', 'пицца с беконом'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['курица', 'цыпленок', 'индейка', 'птица', 'гриль', 'салат', 'козий сыр', 'зелень', 'спаржа', 'цезарь', 'куриная грудка', 'куриное филе', 'куриные бёдра', 'курица табака', 'курица на гриле', 'курица запечённая', 'курица в духовке', 'куриный суп', 'куриный бульон', 'куриные котлеты', 'отбивная куриная', 'куриный шашлык', 'шашлык из курицы', 'куриные крылышки', 'стейк из индейки', 'индейка запечённая', 'рулет из индейки', 'греческий салат', 'салат с курицей', 'теплый салат', 'авокадо', 'брокколи', 'руккола', 'шпинат'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['утка', 'дичь', 'перепел', 'фазан', 'кролик', 'оленина', 'лосось', 'тунец', 'гриб', 'трюфель', 'утиная грудка', 'утка по-пекински', 'конфи из утки', 'кролик тушёный', 'кролик в соусе', 'лань', 'косуля', 'рябчик', 'тетерев', 'запечённый тунец', 'тунец на гриле', 'стейк из тунца', 'лосось стейк', 'запечённый лосось', 'лосось слабосолёный', 'карпаччо из лосося'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['сыр', 'сырная тарелка', 'камамбер', 'бри', 'гауда', 'пармезан', 'мясо', 'телятина', 'лазанья', 'маасдам', 'эдам', 'тильзитер', 'чеддер', 'грюйер', 'эмменталь', 'телячья отбивная', 'телячьи рёбра', 'эскалоп', 'шницель', 'медальоны из телятины', 'запечённая телятина', 'лазанья болоньезе', 'мясная лазанья', 'каннеллони', 'мясные шарики', 'фрикадельки', 'тефтели'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['том ям', 'тайский суп', 'азиатская', 'острое', 'карри', 'суши', 'роллы', 'китайская', 'вьетнамская', 'пад тай', 'вок', 'том кха', 'зеленое карри', 'красное карри', 'курица карри', 'свинина карри', 'нуdles', 'лапша удон', 'лапша соба', 'жареный рис', 'жареная лапша', 'свинина по-китайски', 'утка по-пекински', 'кисло-сладкий', 'кисло-сладкая курица', 'димсам', 'дим сам', 'баозы', 'спринг-роллы', 'весенние роллы', 'морепродукты острые', 'острые креветки'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['десерт', 'торт', 'чизкейк', 'пирожное', 'фрукты', 'тирамису', 'мороженое', 'панакота', 'крем-брюле', 'медовик', 'сладкое', 'наполеон', 'эклер', 'профитроли', 'макаруны', 'клубника', 'малина', 'персик', 'абрикос', 'манго', 'ананас', 'дыня', 'арбуз', 'фруктовый салат', 'ягоды', 'павлова', 'суфле', 'муссовый торт', 'зефир', 'халва', 'пахлава'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['пицца', 'маргарита', 'томатный соус', 'итальянская', 'брускетта', 'капрезе', 'арабьята', 'нисуаз', 'пицца пепперони', 'пицца четыре сезона', 'пицца дьябло', 'пицца с колбасой', 'пицца с помидорами', 'паста с томатным соусом', 'паста путтанеска', 'паста маринара', 'томатный суп', 'гаспачо', 'сальса', 'болоньезе', 'помидоры', 'вяленые томаты', 'тосканская кухня'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['шашлык', 'барбекю', 'гриль', 'люля', 'свинина на мангале', 'хинкали', 'чахохбили', 'сациви', 'грузинская', 'харчо', 'шашлык из свинины', 'шашлык из баранины', 'ребра на мангале', 'мясо на углях', 'стейк на углях', 'мцвади', 'чкмерули', 'аджапсандал', 'лобиани', 'хачапури с мясом', 'свинина жареная', 'рёбрышки гриль', 'свиные рёбра', 'окорок', 'свиная шея', 'карбонат'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['устрицы', 'мидии', 'моллюски', 'гребешки', 'морепродукты', 'севиче', 'тартар из рыбы', 'дорада', 'сибас', 'морской окунь', 'зубатка', 'дорадо', 'морской язык', 'камбала', 'рыба целиком', 'рыба запечённая', 'рыба на соли', 'мидии в соусе', 'мидии в вине', 'запечённые устрицы', 'морской гребешок', 'гребешок жареный', 'рапаны', 'креветки', 'тигровые креветки', 'королевские креветки', 'лангустины', 'лангуст'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['паста с морепродуктами', 'лингвини', 'спагетти с креветками', 'морепродукты', 'паэлья', 'ризотто с морепродуктами', 'паста с кальмарами', 'паста с мидиями', 'паста с лангустинами', 'паста алле вонголе', 'вонголе', 'фрутти ди маре', 'фрутти-ди-маре', 'креветки', 'жареные креветки', 'креветки в соусе', 'креветки гриль', 'криветки с чесноком', 'морской коктейль', 'кальмары', 'кольца кальмара', 'жареный кальмар', 'фаршированный кальмар'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['ризотто', 'ризотто с грибами', 'грибы', 'белые грибы', 'трюфель', 'лисички', 'опята', 'шампиньоны', 'вешенки', 'портобелло', 'грибной суп', 'грибной крем-суп', 'грибная подлива', 'грибная пицца', 'грибная паста', 'жульен с грибами', 'грибы жареные', 'грибы запечённые', 'грибной жюльен', 'картофель с грибами', 'грибное ризотто', 'ризотто из грибов'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['закуска', 'брускетта', 'канапе', 'легкая закуска', 'прошутто', 'карпаччо', 'суши', 'аперитив', 'дни рождения', 'фингерфуд', 'тапас', 'антипасти', 'оливки', 'вяленое мясо', 'сыр с вином', 'лёгкий перекус', 'холодная закуска', 'крудите', 'паштет'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['икра', 'лобстер', 'краб', 'морепродукты', 'устрицы', 'праздник', 'лосось', 'дорогой ресторан', 'крабовые ножки', 'крабовое мясо', 'омар', 'осётр', 'осетрина', 'чёрная икра', 'красная икра', 'блины с икрой', 'морской деликатес', 'изысканный ужин', 'романтический ужин', 'новый год', 'юбилей'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['хамон', 'тапас', 'испанская кухня', 'чоризо', 'паэлья', 'мортаделла', 'мясная нарезка', 'иберийская свинина', 'кордеро', 'ягнёнок по-испански', 'альбондигас', 'пататас бравас', 'тортилья испанская', 'свиная корейка', 'ребра свиные', 'колбаса', 'салями', 'пепперони', 'мясная тарелка', 'колбасная нарезка'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['индийская', 'марокканская', 'тагин', 'карри', 'острое', 'пряное', 'тайская', 'фо бо', 'лапша', 'масала', 'тикка масала', 'курица тикка', 'баранина карри', 'ягнёнок с пряностями', 'самса', 'кускус', 'хумус', 'фалафель', 'шаурма', 'кебаб', 'ближневосточная кухня', 'персидская кухня', 'турецкая кухня', 'иранская кухня', 'бириани', 'пилав пряный'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['греческий салат', 'овощи гриль', 'рататуй', 'нисуаз', 'средиземноморская', 'летний', 'легкий обед', 'овощной', 'кабачки гриль', 'перец гриль', 'баклажан гриль', 'баклажаны', 'цукини', 'стручковая фасоль', 'спаржа', 'цветная капуста', 'вегетарианское', 'веганское', 'тофу', 'хумус', 'табуле', 'оливки', 'моцарелла', 'сёмга слабосолёная', 'лёгкая еда', 'летний обед'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['горький шоколад', 'шоколадный торт', 'голубой сыр', 'рокфор', 'горгонзола', 'десерт', 'шоколадный фондан', 'стилтон', 'дорблю', 'шоколадный брауни', 'шоколадный мусс', 'шоколадное суфле', 'трюфели шоколадные', 'шоколадный ганаш', 'дарк шоколад', 'чёрный шоколад', 'сыр с плесенью'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['стейк', 'говядина', 'мясо', 'ребра', 'бургер', 'барбекю', 'копченое', 'рибай', 'антрекот', 'смоки', 'копчёные рёбра', 'копчёная грудинка', 'паштет из копчёного мяса', 'бараньи рёбра', 'баранья нога', 'ягнёнок', 'говяжьи рёбра', 'говяжья грудинка', 'говяжий стейк', 'нью-йорк стейк', 'портерхаус'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['рыба', 'морепродукты', 'цитрус', 'легкая закуска', 'тар тар', 'севиче', 'устрицы', 'мидии', 'рыбный тартар', 'тартар из лосося', 'тартар из тунца', 'сашими', 'карпаччо из рыбы', 'цитрусовая рыба', 'рыба с лимоном', 'дорада', 'сибас', 'камбала', 'рыба в кляре', 'фиш энд чипс', 'лёгкие морепродукты'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['мясо', 'говядина', 'десерт', 'шоколад', 'форс мажор', 'жульен', 'паштет', 'фуа-гра', 'утиный паштет', 'паштет из печени', 'куриная печень', 'говяжья печень', 'телячья печень', 'ливер', 'дичь жареная', 'перигорская кухня', 'французская кухня', 'бланкет', 'бёф бургиньон', 'жаркое по-французски'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['суши', 'сашими', 'роллы', 'японская', 'рамен', 'темпура', 'мисо суп', 'угорь', 'тунец', 'унаги', 'якитори', 'тонкацу', 'гёза', 'такояки', 'окономияки', 'набэ', 'удон', 'соба', 'японский рис', 'нигири', 'гункан', 'маки', 'онигири', 'эдамаме', 'мисо', 'тофу японский', 'вакаме'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['осьминог', 'кальмар', 'мидии', 'рыба', 'морепродукты', 'паэлья', 'гаспачо', 'испанская', 'осьминог гриль', 'осьминог тушёный', 'кальмар гриль', 'чипироны', 'мидии на пару', 'мидии маринара', 'рыба по-галисийски', 'морской салат', 'ensalada de marisco', 'рыбный суп испанский'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['асадо', 'чоризо', 'аргентинский стейк', 'говядина', 'свинина', 'мясо на гриле', 'шашлык', 'асадо аргентинское', 'пикадильо', 'ломо', 'энтрекот', 'чимичурри', 'мясо с чимичурри', 'говядина на гриле', 'вырезка на гриле', 'свинина на гриле', 'окорок свиной', 'рулька', 'рулька свиная', 'свиная лопатка'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['овощи', 'рататуй', 'брускетта', 'паэлья', 'рыба', 'морепродукты', 'вегетарианское', 'свежие овощи', 'овощной гриль', 'запечённые овощи', 'кабачки', 'баклажаны', 'перец', 'артишок', 'стручковая фасоль', 'кукуруза', 'тыква', 'пюре из тыквы', 'веган', 'без мяса', 'постное', 'лёгкий суп', 'овощной суп', 'минестроне'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['баранина', 'ягненок', 'тапас', 'буйабес', 'рыбный суп', 'прованская кухня', 'средиземноморская', 'бараньи отбивные', 'каре ягнёнка', 'баранья нога', 'ягнёнок запечённый', 'баранина тушёная', 'плов', 'бешбармак', 'казан-кебаб', 'баранья корейка', 'баранья лопатка', 'ягнёнок на гриле', 'ягнёнок с розмарином'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['копченое', 'утка', 'оленина', 'дичь', 'барбекю', 'ребра', 'тёмное мясо', 'гриль мясо', 'копчёная утка', 'утиные ножки', 'конфи', 'кабан', 'медведь', 'бизон', 'дикий кабан', 'говядина вагю', 'вагю', 'длительное тушение', 'braised', 'буйол', 'осьминог тушёный', 'тушёная свинина'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['трюфель', 'тартуфо', 'брезаола', 'пармезан', 'особый случай', 'праздник', 'дорогой ужин', 'белый трюфель', 'чёрный трюфель', 'ризотто с трюфелем', 'паста с трюфелем', 'яйца с трюфелем', 'трюфельное масло', 'выдержанный пармезан', 'пекорино', 'зрелый сыр', 'дегустационное меню', 'гастрономический ужин'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['курица с пряностями', 'тайская', 'лангустин', 'креветки', 'пряная птица', 'морепродукты пряные', 'курица с персиком', 'курица с абрикосом', 'курица в апельсиновом соусе', 'утка с апельсином', 'утка с персиком', 'гусь', 'гусь запечённый', 'перепел с пряностями', 'экзотические специи', 'курица в медовой глазури', 'сладко-пряное'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['тирамису', 'панна котта', 'десерт итальянский', 'кофе', 'дижестив', 'после ужина', 'итальянская кухня', 'кофейный десерт', 'аффогато', 'кофейное мороженое', 'кантуччи', 'бискотти', 'сфольятелла', 'рикотта', 'маскарпоне', 'десерт с маскарпоне', 'торт с кофе', 'бисквит', 'савоярди'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['камамбер', 'свинина', 'яблочный пирог', 'нормандская кухня', 'сыр мягкий', 'фрукты', 'свинина тушёная', 'свинина в яблочном соусе', 'свиные щёки', 'буден нуар', 'кровяная колбаса', 'яблоко', 'яблочный соус', 'яблочный штрудель', 'яблочный крамбл', 'шарлотка', 'утка с яблоками', 'телятина по-нормандски'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['ром коктейль', 'карибская', 'кубинская', 'острые ребра', 'шоколадный торт', 'пряный', 'тёмный десерт', 'рыба карибская', 'курица с ромом', 'свинина карибская', 'банан фламбе', 'ананасовый десерт', 'кокосовые блюда', 'кокосовое молоко', 'маринованное мясо', 'джерк чикен', 'ямайская кухня'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['бургер', 'пицца', 'крылышки', 'нагетсы', 'хот-дог', 'острое', 'фастфуд', 'жареное', 'куриные крылышки', 'куриные ножки', 'жареная курица', 'картошка фри', 'наггетсы', 'сэндвич', 'сабвей', 'клаб-сэндвич', 'ролл с курицей', 'шаурма', 'донер', 'жареная свинина', 'жареные рёбра', 'луковые кольца', 'моцарелла-стики'],
    shopLinks: {
  ...
  },
  {
    ...
    keywords: ['тако', 'мексиканская', 'гуакамоле', 'начос', 'чили', 'буррито', 'фахитас', 'острая мексиканская', 'кесадилья', 'тостада', 'энчилада', 'чили кон карне', 'чили кон карнэ', 'свинина al pastor', 'карнитас', 'мясо по-мексикански', 'халапеньо', 'сальса пикантная', 'острый соус', 'жгучее'],
    shopLinks: {
...
export function matchDrinks(dish: string, prefs: UserPrefs, excludeIds: string[] = []): DrinkMatch[] {
  ...
  if (scored.length === 0) {
    const fallback = DRINKS
      .filter(d => !excludeIds.includes(d.id) && budgetMatches(d, prefs.budget) && typeMatches(d, prefs.alcoholType))
      .slice(0, 3)
      .map(d => ({ drink: d, reason: getReason(d.id), score: 1 }));
    return fallback;
  }
...
const UNIVERSAL_FOOD_WORDS = [
  'мясо', 'рыба', 'птица', 'овощи', 'морепродукты', 'паста', 'суп', 'салат',
  'гриль', 'запечённый', 'запеченный', 'жареный', 'тушёный', 'тушеный',
  'курица', 'говядина', 'свинина', 'баранина', 'телятина', 'утка', 'индейка',
  'лосось', 'семга', 'форель', 'треска', 'тунец', 'сибас', 'дорада',
  'креветки', 'мидии', 'устрицы', 'кальмар', 'осьминог', 'краб', 'лобстер',
  'сыр', 'грибы', 'десерт', 'торт', 'пицца', 'бургер', 'шашлык',
  'стейк', 'рибай', 'ризотто', 'суши', 'роллы', 'карри', 'карбонара',
  'блюдо', 'еда', 'ужин', 'обед', 'завтрак', 'закуска', 'перекус',
];
...
export function isDishRecognized(dish: string): boolean {
  ...
  for (const word of UNIVERSAL_FOOD_WORDS) {
    if (dishLower.includes(word)) return true;
  }
